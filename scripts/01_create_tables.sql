...
*/
Create a table named tblStudents with the following columns: - student_id (INT, PRIMARY KEY, AUTO_INCREMENT) - student_name (VARCHAR(50)) - student_email (VARCHAR(50)) - student_phone (VARCHAR(50))